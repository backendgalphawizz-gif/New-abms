...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('check-pincode', 'WebController@checkcode')->name('check-pincode');

    Route::post('update_city_session', 'HomeController@updateCitySession')->name('update_city_session');
    Route::get('check-city-session', 'HomeController@checkCitySession')->name('check-city-session');
    ...
    Route::group(['middleware'=>['customer']], function () {
        ...
        Route::get('buy-cart', 'WebController@buy_cart')->name('buy-cart');
        ...
        Route::post('save-later', 'CartController@save_later')->name('save-later');
        Route::post('remove-save-later', 'CartController@remove_save_later')->name('remove-save-later');

        // CAB / accreditation customer portal (web layout from mobile)
        Route::group(['prefix' => 'portal', 'as' => 'portal.'], function () {
            Route::get('/', 'CustomerPortalController@home')->name('home');
            Route::get('apply', 'CustomerPortalController@applyForm')->name('apply');
            Route::post('apply', 'CustomerPortalController@applyStore')->name('apply.store');
            Route::get('apply/employee', 'CustomerPortalController@applyEmployeeForm')->name('apply.employee');
            Route::post('apply/employee', 'CustomerPortalController@applyEmployeeStore')->name('apply.employee.store');
            Route::get('apply/employee-more', 'CustomerPortalController@applyEmployeeMoreForm')->name('apply.employee.more');
            Route::post('apply/employee-more', 'CustomerPortalController@applyEmployeeMoreStore')->name('apply.employee.more.store');
            Route::get('apply/audit', 'CustomerPortalController@applyAuditForm')->name('apply.audit');
            Route::post('apply/audit', 'CustomerPortalController@applyAuditStore')->name('apply.audit.store');
            Route::get('apply/documents', 'CustomerPortalController@applyDocumentsForm')->name('apply.documents');
            Route::post('apply/documents', 'CustomerPortalController@applyDocumentsStore')->name('apply.documents.store');
            Route::get('apply/agreement', 'CustomerPortalController@applyAgreementForm')->name('apply.agreement');
            Route::post('apply/agreement', 'CustomerPortalController@applyAgreementStore')->name('apply.agreement.store');
            Route::get('apply/payment', 'CustomerPortalController@applyPaymentForm')->name('apply.payment');
            Route::post('apply/payment', 'CustomerPortalController@applyPaymentStore')->name('apply.payment.store');
            Route::get('applications', 'CustomerPortalController@applications')->name('applications');
            Route::get('applications/{application}', 'CustomerPortalController@applicationShow')->name('applications.show');
            Route::post('applications/{application}/respond', 'CustomerPortalController@respond')->name('applications.respond');
        });
    });
    ...
    Route::get('become-seller', 'PageController@become_seller')->name('become-seller');
    ...
    Route::get('products-for', 'ProductListController@showAllProducts')->name('products-for');
    ...
    Route::get('user-subscription', 'UserProfileController@user_subscription')->name('user-subscription')->middleware('customer'); //theme_aster
    Route::post('user-subscription-purchased', 'UserProfileController@plan_purchased')->name('user-purchased')->middleware('customer'); //theme_aster
    
    Route::get('user-account', 'UserProfileController@user_account')->name('user-account')->middleware('customer');
    Route::get('user-change-password', 'UserProfileController@user_change_password')->name('user-change-password')->middleware('customer');
    Route::post('user-update-password', 'UserProfileController@user_update_password')->name('user-update-password');
    ...
    Route::get('account-order', 'UserProfileController@account_oder')->name('account-oder')->middleware('customer');
    Route::post('ajax-account-order', 'UserProfileController@account_oder')->name('fetch-customer-orders')->middleware('customer');
    
    
    Route::get('mark-all-read', 'UserProfileController@mark_as_read')->name('mark-all-read')->middleware('customer');
    ...
    Route::get('transactions','UserWalletController@transactions')->name('transactions');
    Route::post('add-wallet-amount','UserWalletController@add_wallet')->name('add-wallet');
...
Route::group(['prefix' => 'shop', 'as' => 'shop.', 'namespace' => 'Seller\Auth'], function () {
    ...
    Route::get('user-subscription', 'RegisterController@subscription')->name('subscription');
...
Route::get('send-notification', 'Web\WebController@send_notification');
