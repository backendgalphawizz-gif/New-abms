...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::get('sign-up', 'RegisterController@create');
        // Route::get('sign-up', 'RegisterController@create');
        

    });
    Route::post('validate-email', 'Auth\RegisterController@validateEmail')->name('register.valildate-email');
    Route::post('validate-mobile', 'Auth\RegisterController@validateMobile')->name('register.valildate-mobile');
    Route::post('send-seller-otp', 'Auth\RegisterController@sendOtp')->name('register.send-seller-otp');
    Route::post('verify-otp', 'Auth\RegisterController@verifyOtp')->name('register.verify-otp');
    Route::post('login-with-otp', 'Auth\RegisterController@loginWithOtp')->name('register.login-with-otp');
    
    Route::post('get-states', 'SupplierController@getState')->name('state.list');
    Route::post('get-cities', 'SupplierController@getCity')->name('city.list');
    Route::post('get-area', 'SupplierController@getArea')->name('area.list');
    
    /*authenticated*/
    Route::group(['middleware' => ['seller']], function () {
        //dashboard routes
        Route::group(['prefix' => 'customer', 'as' => 'customer.'], function () {
            Route::get('list', 'DashboardController@dashboard')->name('list');
        });
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.'], function () {
         ...
         Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::get('list', 'BusinessSettingsController@list')->name('list');
        });
        ...
        Route::group(['prefix' => 'supplier', 'as' => 'supplier.'], function () {
            Route::get('add-new', 'SupplierController@add_new')->name('add-new')->middleware('actch');
            Route::post('store-coupon', 'SupplierController@store')->name('store-coupon');
            Route::get('update/{id}', 'SupplierController@edit')->name('update')->middleware('actch');
            Route::post('update/{id}', 'SupplierController@update');
            Route::get('quick-view-details', 'SupplierController@quick_view_details')->name('quick-view-details');
            Route::get('status/{id}/{status}', 'SupplierController@status_update')->name('status');
            Route::delete('delete/{id}', 'SupplierController@delete')->name('delete');

        });

        Route::get('/suppliers', 'SupplierController@add_new')->name('supplier');
        ...
        Route::group(['prefix' => 'profile', 'as' => 'profile.'], function () {
            ...
            Route::post('update-setting/{id}', 'ProfileController@update2')->name('update2');
        ...
        Route::group(['prefix' => 'wallet', 'as' => 'wallet.'], function () {
            Route::get('view', 'ProfileController@wallet_view')->name('view');
            Route::post('add-money', 'ProfileController@add_money_wallet')->name('add-money');
        });
