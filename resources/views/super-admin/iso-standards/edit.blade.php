...
@section('title', \App\CPU\translate('Super Admin') . ' | Edit ISO Standard')
...
@section('content')
    <div class="content container-fluid">
        <div class="page-header pb-3 mb-3 border-0">
            <h1 class="page-header-title"><b>Edit ISO Standard</b></h1>
            <p class="text-muted mb-0">Update checklist option for entity creation.</p>
        </div>

        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('super-admin.iso-standards.update', $standard) }}">
