            ...
            <div class="navbar-nav-wrap-content-right"
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    <!--<li class="nav-item d-none d-sm-inline-block">
                        ...
                        <!-- d-md-inline-block -->
                    <li class="nav-item  language-none d-none">
                        <div class="hs-unfold">
                            <div>
                                @php( $local = session()->has('local')?session('local'):'en')
                                @php($lang = \App\Model\BusinessSetting::where('type', 'language')->first())
                                <div
                                    class="topbar-text dropdown disable-autohide d-flex align-items-center {{Session::get('direction') === "rtl" ? 'ml-3' : 'm-1'}} text-capitalize">
                                    ...
                                    <a class="topbar-link d-flex align-items-center title-color"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                      <path d="M15.8346 7.08325L10.0013 12.9166L4.16797 7.08325" stroke="#E3E1EC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="nav-item  d-none">
                        <div class="hs-unfold">
                            <a title="Website home"
                               ...
                               href="{{ Route::has('home') ? route('home') : url('/') }}" target="_blank">
                                <i class="tio-globe"></i>
                            </a>
                        </div>
                    </li>
                            ...
                            <div class="hs-unfold">
                                <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                                   href="{{route('admin.contact.list')}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                      <path fill-rule="evenodd" clip-rule="evenodd" d="M12.0833 17.2064C16.7827 17.2064 18.9567 16.6035 19.1667 14.1838C19.1667 11.7657 17.651 11.9212 17.651 8.95426C17.651 6.63678 15.4544 4 12.0833 4C8.71231 4 6.51571 6.63678 6.51571 8.95426C6.51571 11.9212 5 11.7657 5 14.1838C5.21079 16.6127 7.38481 17.2064 12.0833 17.2064Z" stroke="#E1F4F4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M14.0734 19.7144C12.9366 20.9766 11.1633 20.9916 10.0156 19.7144" stroke="#E1F4F4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                            ...
                            <a class="js-hs-unfold-invoker media align-items-center gap-3 navbar-dropdown-account-wrapper "
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="d-none d-md-block media-body">
                                    <h5 class="profile-name mb-0" title="{{auth('admin')->user()->name}}">{{auth('admin')->user()->name}}</h5>
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item"
                                   href="{{route('admin.profile.update',auth('admin')->user()->id)}}">
                                    <span class="text-truncate pr-2" title="Settings">{{ \App\CPU\translate('Profile')}}</span>
                                </a>
