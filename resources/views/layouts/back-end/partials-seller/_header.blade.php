            ...
            <div class="navbar-nav-wrap-content-left">
                ...
                <button type="button" class="js-navbar-vertical-aside-toggle-invoker close mr-3 ">
                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                     <path d="M21 6H3M15 12H3M17 18H3" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                 </svg>
                </button>
                        ...
                        <div class="hs-unfold d-none">
                            <div>
                                ...
                                <div
                                    ...
                                    <a class="topbar-link dropdown-toggle text-white d-flex align-items-center title-color" href="#" data-toggle="dropdown"
                                       >
                            ...
                            <a class="js-hs-unfold-invoker media align-items-center gap-3 navbar-dropdown-account-wrapper dropdown-toggle dropdown-toggle-left-arrow" href="javascript:;"
                               data-hs-unfold-options='{
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                  <path d="M15.8346 7.08325L10.0013 12.9166L4.16797 7.08325" stroke="#E3E1EC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </a>
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center text-break">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span class="card-text" title="{{auth('seller')->user()->email}}">{{auth('seller')->user()->email}}</span>
                                        </div>
