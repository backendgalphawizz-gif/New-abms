                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="mt-2" for="name" class="title-color">{{\App\CPU\translate('Bank Name')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="bank_name" value="{{$data->bank_name}}"
                                               class="form-control" id="name"
                                               required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="mt-2" for="name" class="title-color">{{\App\CPU\translate('Branch Name')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="branch" value="{{$data->branch}}" class="form-control"
                                               id="name"
                                               required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="mt-2" for="account_no" class="title-color">{{\App\CPU\translate('Holder Name')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="holder_name" value="{{$data->holder_name}}"
                                               class="form-control" id="account_no"
                                               required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="mt-2" for="account_no" class="title-color">{{\App\CPU\translate('Account No')}} <span class="text-danger">*</span></label>
