        ...
        <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url()->current() }}" id="form-data" method="GET">
                        <div class="row gy-3 gx-2">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <button type="submit" class="btn btn--primary btn-block showbtn">
            ...
            <div class="card-body">
                ...
                <div class="row g-2 mb-20">
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <a class="order-stats order-stats_pending" href="{{route('seller.orders.list', ['pending', 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search])}}">
                            <div class="order-stats__content">
                                ...
                                <img src="{{asset('/public/assets/back-end/img/pending-icon.png')}}" alt="">
                                  </div>
                            </div>
                            <div class="cardtext">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <a class="order-stats order-stats_confirmed" href="{{route('seller.orders.list', ['confirmed', 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search])}}">
                            <div class="order-stats__content">
                                ...
                                <img src="{{asset('/public/assets/back-end/img/check.png')}}" alt="">
                                 </div>
                                </div>
                                    <div class="cardtext">
                    ...
                    <div class="col-sm-6 col-lg-3 d-none">
                        ...
                        <a class="order-stats order-stats_packaging" href="{{route('seller.orders.list', ['processing', 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search])}}">
                            <div class="order-stats__content">
                                ...
                                <img src="{{asset('/public/assets/back-end/img/packing-icon.png')}}" alt="">
                                </div>
                            </div>
                             <div class="cardtext">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <!-- Order Stats -->
                        <a class="order-stats order-stats_shipped" href="{{route('seller.orders.list', ['shipped', 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search])}}">
                            <div class="order-stats__content">
                                <div class="packingicon">
                                <img src="{{asset('/public/assets/back-end/img/packing-icon.png')}}" alt="">
                                </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <a class="order-stats order-stats_out-for-delivery" href="{{route('seller.orders.list', ['out_for_delivery', 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search])}}">
                            <div class="order-stats__content">
                                ...
                                <img width="20" src="{{asset('/public/assets/back-end/img/out-delivered.png')}}" alt="">
                                 </div>
                            </div>
                            <div class="cardtext">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <a class="order-stats order-stats_delivered" href="{{route('seller.orders.list', ['delivered', 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search])}}">
                            <div class="order-stats__content">
                                ...
                                <img src="{{asset('/public/assets/back-end/img/deliveredicon.png')}}" alt="">
                                    </div>
                            </div>
                            <div class="cardtext">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <a class="order-stats order-stats_canceled" href="{{route('seller.orders.list', ['canceled', 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search])}}">
                            <div class="order-stats__content">
                                ...
                                <img src="{{asset('/public/assets/back-end/img/close.png')}}" alt="">
                                 </div>
                            </div>
                            <div class="cardtext">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <a class="order-stats order-stats_returned" href="{{route('seller.orders.list', ['returned', 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search])}}">
                            <div class="order-stats__content">
                                ...
                                <img src="{{asset('/public/assets/back-end/img/returnicon.png')}}" alt="">
                                  </div>
                            </div>
                                  <div class="cardtext">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <a class="order-stats order-stats_failed" href="{{route('seller.orders.list', ['failed', 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search])}}">
                            <div class="order-stats__content">
                                ...
                                <img width="20" src="{{asset('/public/assets/back-end/img/failed.png')}}" alt="">
                                 </div>
                            </div>
                            <div class="cardtext">
                ...
                <div class="px-3 py-4 light-bg">
                    <div class="row g-2 flex-grow-1">
                        ...
                        <div class="col-sm-4 col-md-6 col-lg-8 d-flex justify-content-sm-end">
                            <button type="button" class="btn btn-outline--primary exportbtn" data-toggle="dropdown">
                                <i class="tio-download-to"></i>
                                {{\App\CPU\translate('export')}}
                                <i class="tio-chevron-down"></i>
                            </button>

                            <ul class="dropdown-menu dropdown-menu-right exceldropdiv">
                                <li>
