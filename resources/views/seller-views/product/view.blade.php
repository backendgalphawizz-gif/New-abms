                            ...
                            <div class="row gy-1">
                                @foreach (json_decode($product->images) as $key => $photo)
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="width-100" style="cursor: pointer;" onclick="showImageModal('{{ asset("storage/app/public/product/$photo") }}')" onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
