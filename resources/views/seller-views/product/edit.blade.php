        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{route('seller.product.update',$product->id)}}" method="post"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="number" min="0" step="0.01"
                                                        placeholder="{{\App\CPU\translate('MRP') }}"
                                                        name="unit_price" class="form-control"
                                                        value="{{\App\CPU\BackEndHelper::usd_to_currency($product->unit_price)}}" id="unit_price" required>
                                                </div>

                                                <div class="col-md-4 mb-3">
                                                    <label class="title-color">{{ \App\CPU\translate('Selling_price') }}</label>
                                                    <input type="number" min="0" step="0.01"
                                                        placeholder="{{ \App\CPU\translate('selling_price') }}" name="selling_price"
                                                        value="{{\App\CPU\BackEndHelper::usd_to_currency($product->selling_price)}}" class="form-control" required id="selling_price">
                                                </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="number" min="0" step="0.01"
                                                        ...
                                                        class="form-control" id="discount_percent" readonly required>
                                                </div>
                                                ...
                                                <!-- Shipping Cost -->
                                                <div class="d-none col-md-4 mb-3 physical_product_show" id="shipping_cost">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3 d-none physical_product_show" id="shipping_cost_multy">
                                                    <div>
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h4 class="mb-0">{{\App\CPU\translate('Packaging')}}</h4>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="name" class="title-color">{{\App\CPU\translate('Alternative_Unit')}}</label>
                                        <select
                                            class="js-example-basic-multiple js-states js-example-responsive form-control"
                                            name="unit">
                                    ...
                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="per_pack_quantity" class="title-color">{{ \App\CPU\translate('per_pack_unit') . ' (' . implode(', ', \App\CPU\Helpers::units()) . ')' }}</label>
                                        <input type="number" min="0"
                                            placeholder="{{ \App\CPU\translate('per_pack_unit') . ' (' . implode(', ', \App\CPU\Helpers::units()) . ')' }}" name="per_pack_quantity"
                                            value="{{ $product->per_pack_quantity ?? '' }}" class="form-control">
                                    </div>
                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="per_unit_price" class="title-color">{{ \App\CPU\translate('Per_Unit_price') }}(If Any)</label>
                                       <input type="number" min="0" step="0.01"
                                            placeholder="{{ \App\CPU\translate('per_unit_price') }}" name="per_unit_price"
                                            value="{{ $product->per_unit_price ?? '' }}" class="form-control">
                                    </div>
                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="name" class="title-color">{{ \App\CPU\translate('package') }}</label>
                                        <select class="js-example-basic-multiple form-control" name="package">
                                            @foreach (\App\CPU\Helpers::packages() as $x)
                                                <option value="{{ $x }}"
                                                    {{  $product->package==$x ? 'selected' : '' }}>
                                                    {{ ucfirst($x) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="pack_quantity" class="title-color">{{ \App\CPU\translate('pack_quantity') }}</label>
                                       <input type="number" min="0" step="0.01"
                                            placeholder="{{ \App\CPU\translate('pack_quantity') }}" name="pack_quantity"
                                            value="{{ $product->pack_quantity ?? '' }}" class="form-control" id="pack_quantity">
                                            <div id="pack_quantity_error" class="text-danger" style="display: none;">{{ \App\CPU\translate('Please_enter_pack_quantity_first') }}</div>
                                    </div>
                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="net_weight" class="title-color">{{ \App\CPU\translate('net_weight') }}</label>
                                         <span>({{ \App\CPU\translate('for_backend_purpose_only') }})</span>
                                       <input type="number" min="0" step="0.01"
                                            placeholder="{{ \App\CPU\translate('net_weight') }}" name="net_weight"
                                            value="{{ $product->net_weight ?? '' }}" class="form-control" id="pack_weight" disabled>
                                    </div>
                                    
                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="calculated_package_weight" class="title-color">{{ \App\CPU\translate('calculated_package_weight') }}</label>
                                        <input type="number" min="0" step="0.01"
                                            placeholder="{{ \App\CPU\translate('calculated_package_weight') }}" name="package_weight"
                                            value="{{ $product->package_weight ?? '' }}" class="form-control" id="calculated_package_weight" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card mt-2 mb-2 rest-part">
                        <div class="card-header " style="display: flex; justify-content: flex-start;">
                            ...
                            <label class="switcher ml-2">
                                <input type="checkbox"
                                    class="switcher_input"
                                    id="bulk_switcher"
                                    name="is_bulk_pricing"
                                    value="1"
                                    {{ old('is_bulk_pricing', $product->is_bulk_pricing ?? false) ? 'checked' : '' }}>

                                <span class="switcher_control"></span>
                            </label>
                        </div>
                        <div class="card-body pb-0" id="bulkDiv"
                            style="{{ old('is_bulk_pricing', $product->is_bulk_pricing ?? false) ? '' : 'display: none;' }}">

                            <div class="row g-2" id="sku_bulk_combination">
                                @if(isset($product->bulk_prices))
                                    @foreach($product->bulk_prices as $bulk)
                                        <div class="col-md-6">
                                            <input type="number" name="bulk_qty[]" class="form-control mb-2"
                                                value="{{ $bulk->min_qty }}" placeholder="Min Qty">
                                            <input type="number" name="bulk_price[]" class="form-control"
                                                value="{{ $bulk->price }}" placeholder="Price">
                                        </div>
                                    @endforeach
                                @endif
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2 d-flex flex-wrap gap-1 align-items-baseline">
                                        ...
                                        <small class="text-info">* ( {{\App\CPU\translate('ratio')}}  4:5 )</small>
                                    </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            // Bulk pricing toggle handler
            function toggleBulkPricing() {
                if ($('#bulk_switcher').is(':checked')) {
                    $('#bulkDiv').stop(true, true).slideDown();
                } else {
                    $('#bulkDiv').stop(true, true).slideUp();
                }
            }
            ...
            // Run on toggle
            $('#bulk_switcher').on('change', function () {
                toggleBulkPricing();
            });
            ...
            function calculateDiscount() {
                ...
                if (selling_price > unit_price) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Selling price should not be greater than MRP!'
                    });
                    $('#selling_price').val(0);
                    $('#discount_percent').val(0);
                    return;
                ...
                const discountPercent = ((unit_price - selling_price) / unit_price) * 100;
                $('#discount_percent').val(discountPercent.toFixed(2));
            }

            // Attach event listener
            $(document).on('keyup change', '#selling_price, #unit_price', calculateDiscount);

            // Optional: Trigger discount calculation on page load (useful for edit pages)
            $(document).ready(function () {
                calculateDiscount();
            });
    ...
    <script>
       ...
       $(document).on('change', '.call-update-sku', function () {
            update_sku();
        });
       ...
       function update_sku() {
            ...
            $.ajax({
                ...
                success: function(data) {
                // console.log(data.bulkview);
                
                    $('#sku_combination').html(data.view);
                    $('#sku_bulk_combination').html(data.bulkview);
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const calculatedPackageWeightInput = document.getElementById('calculated_package_weight');
        const packQuantityError = document.getElementById('pack_quantity_error');

        function calculatePackageWeight() {
            const packQuantity = parseFloat(packQuantityInput.value) || 0;
            const packWeight = parseFloat(packWeightInput.value) || 0;

            const calculatedWeight = packQuantity * packWeight;

            calculatedPackageWeightInput.value = calculatedWeight.toFixed(2);
        }

 
        packQuantityInput.addEventListener('input', function () {
            if (packQuantityInput.value.trim() !== '') {
                packWeightInput.disabled = false;
                packQuantityError.style.display = 'none'; 
            } else {
                packWeightInput.disabled = true;
                packQuantityError.style.display = 'block'; 
            }
            calculatePackageWeight();
        });

        packWeightInput.addEventListener('input', calculatePackageWeight);
    });
    </script>
