        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{ route('seller.product.add-new') }}" method="post"
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" min="0" step="0.01"
                                                placeholder="{{ \App\CPU\translate('MRP') }}" name="unit_price"
                                                value="{{ old('unit_price') }}" class="form-control" required id="unit_price">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" min="0" step="0.01"
                                                ...
                                                value="{{ old('selling_price') }}" class="form-control" required id="selling_price">
                                        </div>
                                        <!-- <div class="col-md-4 mb-3">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" min="0" value="0" step="0.01"
                                                ...
                                                value="{{ old('discount') }}" class="form-control" id="discount_percent" readonly required>
                                        </div>
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h5 class="mb-0">{{ \App\CPU\translate('Packaging') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="unit" class="title-color">{{ \App\CPU\translate('Alternative_Unit') }}</label>
                                    ...
                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="package_weight" class="title-color">{{ \App\CPU\translate('package_weight') }}</label>
                                        <input type="number" min="0" step="0.01"
                                            placeholder="{{ \App\CPU\translate('package_weight') }}" name="package_weight"
                                            class="form-control">
                                     </div> -->
                                      <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="pack_quantity" class="title-color">{{ \App\CPU\translate('pack_quantity') }}</label>
                                        <input type="number" min="0" step="0.01" placeholder="{{ \App\CPU\translate('pack_quantity') }}" name="pack_quantity" class="form-control" id="pack_quantity">
                                        <div id="pack_quantity_error" class="text-danger" style="display: none;">{{ \App\CPU\translate('Please_enter_pack_quantity_first') }}</div>
                                    </div>
                                    

                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="net_weight" class="title-color">{{ \App\CPU\translate('Net weight') }}</label>
                                          <span>({{ \App\CPU\translate('for_backend_purpose_only') }})</span>
                                        <input type="number" min="0" step="0.01" placeholder="{{ \App\CPU\translate('Net weight') }}" name="net_weight" class="form-control" id="pack_weight" disabled>
                                    </div>

                                    <div class="col-md-4 mb-3 physical_product_show">
                                        <label for="calculated_package_weight" class="title-color">{{ \App\CPU\translate('calculated_package_weight') }}</label>
                                        <input type="text" readonly id="calculated_package_weight" name="package_weight" class="form-control" readonly>
                                    </div>
                    ...
                    <div class="card mt-2 mb-2 rest-part">
                        <div class="card-header " style="DISPLAY: flex; JUSTIFY-CONTENT: flex-start;">
                            ...
                            <label class="switcher ml-2">
                                <input type="checkbox" class="switcher_input" id="bulk_switcher" value="1" name="is_bulk_pricing">
                                <span class="switcher_control"></span>
                            </label>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    <div class="mb-2">
                                        ...
                                        <span class="text-info">* ( {{ \App\CPU\translate('ratio 4:5') }} )</span>
                                    </div>
...
@push('script')
    ...
    <script>
        function calculateDiscount() {
            ...
            if (selling_price > unit_price) {
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'Seller price should not be greater than MRP!'
                });
                $('#selling_price').val(0);
                $('#discount_percent').val(0);
                return;
        ...
        $(document).on('keyup', '#selling_price, #unit_price', calculateDiscount);
    </script>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#bulk_switcher').click(function(){
                var checkBoxes1 = $("#bulk_switcher");
                if ($('#bulk_switcher').prop('checked')) {
                    $('#bulkDiv').show();
                } else {
                    $('#bulkDiv').hide();
                }
