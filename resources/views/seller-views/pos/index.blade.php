                    ...
                    <div class="card billing-section-wrap">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-2 flex-wrap flex-sm-nowrap mb-3">
                                <select id='current_customer_address' name="current_customer_address" class=" form-control js-select2-custom" onchange="customer_address_change(this.value)">
                                </select>
                            </div>
                            <div class="d-flex gap-2 flex-wrap flex-sm-nowrap mb-3">
                    ...
                    >
                        ...
                        <div class="row pl-2">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <label class="input-label">{{\App\CPU\translate('name')}} <span
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <label class="input-label">{{\App\CPU\translate('email')}}<span
                                            class="input-label-secondary text-danger">(Optional)</span></label>
                        ...
                        <div class="row pl-2">
                            <div class="col-12 col-lg-6 d-none">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country" class="form-control" value="India" placeholder="{{\App\CPU\translate('country')}}" required>
                                </div>
                            </div>
                            {{-- 
                            <div class="col-12 col-lg-6">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <label for="shop_address" class="title-color">{{ \App\CPU\translate('shop_address') }}</label>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class=" form-group">
                                    ...
                                    <select name="state" class="form-control" id="state">
                                        @foreach ((\App\Model\State::get()) as $key=>$value )
...
<script>
    ...
    function customer_change(val) {
        ...
        $.post({
            ...
            success: function (data) {
                ...
                $.each(data.customer_address, function(index, address) {
                    address_option += `<option value="${address.id}">${address.address} ${address.city}, ${address.zip}</option>`
                })
                console.log('address_option ', address_option)
                $('#current_customer_address').html(address_option);
    ...
    function customer_address_change(val) {
        let cart_id = $('#cart_id').val();
