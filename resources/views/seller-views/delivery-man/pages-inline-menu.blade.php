<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="d-none {{ Request::is('seller/delivery-man/order-wise-earning*') ?'active':'' }}"><a href="{{ route('seller.delivery-man.order-wise-earning', ['id' => $delivery_man['id']]) }}">{{\App\CPU\translate('Earning')}}</a></li>
    </ul>
</div>
