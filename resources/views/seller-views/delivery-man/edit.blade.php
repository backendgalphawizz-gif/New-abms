                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="title-color">{{\App\CPU\translate('RC')}} {{\App\CPU\translate('number')}}</label>
                                <input type="text" name="registeration_number" value="{{$delivery_man['registeration_number']}}"
                                        class="form-control"
                                        placeholder="{{\App\CPU\translate('Ex : MH-01-AB-1234')}}"
                                        >
                            </div>
                            
                            <div class="form-group">
                                <label class="title-color"> {{\App\CPU\translate('Driver License Issue')}}</label>
                                <input type="date" name="license_doi" id="license_doi" max="{{ date('Y-m-d') }}" value="{{$delivery_man['license_doi']}}"
                                        class="form-control"
                                        placeholder="{{\App\CPU\translate('Ex : MH-01-AB-1234')}}"
                                        >
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="identity_type" class="form-control">
                                    ...
                                    <option
                                     ...
                                     <option
                                        value="aadharcard" {{$delivery_man['identity_type']=='aadharcard'?'selected':''}}>
                                        {{\App\CPU\translate('aadharcard')}} 
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="title-color"> {{\App\CPU\translate('Driver License Number')}}</label>
                                <input type="number" name="license_number" value="{{$delivery_man['license_number']}}"
                                        class="form-control"
                                        placeholder="{{\App\CPU\translate('Ex : MH-01-AB-1234')}}"
                                        >
                            </div>
                             <div class="form-group">
                                <label class="title-color"> {{\App\CPU\translate('Driver License Expiry')}}</label>
                                <input type="date" name="license_exp_date"id="license_exp_date"  min="{{ old('license_doi') ?? '' }}" value="{{$delivery_man['license_exp_date']}}"
                                        class="form-control"
                                        placeholder="{{\App\CPU\translate('Ex : MH-01-AB-1234')}}"
                                        >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <center class="mt-4">
                                    <img class="upload-img-view" id="viewerRcImage"
                                        src="{{ $delivery_man->rc_image ? asset('storage/app/public/delivery-man/'.$delivery_man->rc_image) : asset('public/assets/back-end/img/400x400/img2.jpg') }}"
                                        alt="rc image"/>
                                </center>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <center>
                                        <img class="upload-img-view" id="viewer"
                                            src="{{ $delivery_man['image'] ? asset('storage/app/public/delivery-man/' . $delivery_man['image']) : asset('public/assets/back-end/img/400x400/img2.jpg') }}"
                                ...
                                <div>
                                    <div class="row" id="coba">
                                        ...
                                        @foreach($identity_images as $img)
                                            <div class="col-md-4 mb-3 existing-image-wrapper">
                                                <img height="150" src="{{asset('storage/app/public/delivery-man').'/'.$img}}">
                                                <input type="hidden" name="existing_identity_images[]" value="{{$img}}">
                                                <button type="button" class="btn btn-danger btn-sm remove-existing-image">Remove</button>
                                            </div>
                                        @endforeach
