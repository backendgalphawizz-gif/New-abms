...
@section('content')
    <div class="content container-fluid">
        <!-- Page Title -->
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2 editback">
                <div class="imgicon">
                ...
                <div class="row g-2" id="order_stats">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card h-100 d-flex justify-content-center align-items-center">
                            <div class="card-body d-flex flex-column gap-10 align-items-center justify-content-center">
                                <img width="48" src="{{ asset('public/assets/back-end/img/cc.png')}}" alt="">
                                <h3 class="for-card-count mb-0 fz-24">{{ $total_order_amount ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total_order_amount)) : \App\CPU\BackEndHelper::set_symbol(0) }}</h3>
                                <div class="font-weight-bold text-capitalize mb-30">
                                    {{\App\CPU\translate('Total Order Amount')}}
                                </div>
                            </div>
                        </div>
                        <!-- End Card -->
