                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{old('license_number')}}" type="number" name="license_number" class="form-control"
                                placeholder="Ex : MH-01-AB-1234">
                        </div>
                         <div class="form-group">
                            <label class="title-color" for="exampleFormControlInput1">{{\App\CPU\translate('Driver License Expiry')}}</label>
                            <input value="{{old('license_exp_date')}}" id="license_exp_date"  min="{{ old('license_doi') ?? '' }}" type="date" name="license_exp_date" class="form-control"
                                placeholder="Ex : MH-01-AB-1234">
                        </div>
                    </div>
                </div>
