...
<main id="content" role="main" class="main __inline-20">
    ...
    <div class="container py-5 py-sm-7">
        ...
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2 __w-rem d-none"  src="{{asset("storage/app/public/company/".$e_commerce_logo)}}" alt="Logo"
      ...
      <div class="card-body">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 text-center auth-right">
                       ...
                       <h2 class="h3 mb-4">{{\App\CPU\translate('Enter_your_OTP_and_proceed')}}?</h2>
