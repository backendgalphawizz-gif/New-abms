...
<main id="content" role="main" class="main">
    ...
    <div class="container py-5 py-sm-7">
        ...
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2 __w-8rem d-none"  src="{{asset("storage/app/public/company/".$e_commerce_logo)}}" alt="Logo"
        ...
        <div class="row justify-content-center ">
            <div class="col-lg-8 col-md-10 card">
                <h2 class="h3 mb-4 d-none">{{\App\CPU\translate('forgot_password?')}}</h2>
                <p class="font-size-md d-none">{{\App\CPU\translate('follow_steps')}}</p>
                <ol class="list-unstyled font-size-md d-none">
                ...
                <div class="col-md-6">
                   ...
                   <img width="100%" class="dark-support" src="{{asset('public/assets/back-end/img/login-img/login-img.webp')}}" alt="">
                                ...
                                <ol class="list__ol__numberic">
                                <li class="text-white">{{\App\CPU\translate('Fill in your email address below')}}.</li>
                                <li  class="text-white">{{\App\CPU\translate('We will send email you a temporary code')}}.</li>
                                <li  class="text-white">{{\App\CPU\translate('Use the code to change your password on our secure
                                                 website')}}.
                                 </li>
                </ol>
                      ...
                      <div class="col-md-6">
                         ...
                         <div class="auth__right__side h-100 align-items-center d-flex w-100">
                ...
                @else
                    <div class="h-100 align-items-center d-flex py-2 mt-4 w-100">
