        ...
        <!-- <a class="d-flex justify-content-center mb-5" href="javascript:">
            ...
            <div class="card-body">
                           <div class="row">
                                            ...
                                            <div class="">
                                                <div class="log-in-bar">
                                                    <img width="100%" class="dark-support" src="{{asset('public/assets/back-end/img/login-img/login-bg-set.png')}}" alt="">
                                                        ...
                                                        <li class="text-white">{{\App\CPU\translate('follow_steps')}}secure.</li>
                                                        <li class="text-white">{{\App\CPU\translate('new_password')}}.</li>
                                                        <li  class="text-white">{{\App\CPU\translate('confirm_password')}}.</li>
                               ...
                               <div class="col-md-6 d-flex justify-content-center flex-column g-3">
                                     
               
           
                <div class="">
                <img src="{{asset('public/assets/back-end/img/login-img/semi-logo-for-company.svg')}}" alt="">
                <h2 class="mb-2">{{\App\CPU\translate('forget_your_password')}}?</h2>
