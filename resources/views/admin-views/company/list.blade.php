...
@section('title', \App\CPU\translate('Companies'))
        ...
        <div class="mb-4">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-baseline gap-2 backbtndiv w-100">
                ...
                <a class="textfont-set" href="{{route('admin.dashboard.index')}}"> 
                 ...
                 <div class="backdiv">
                {{\App\CPU\translate('Companies')}}
                <span class="badge badge-soft-dark radius-50">{{\App\Model\CompanyProfile::count()}}</span>
                </div>
            </h2>
        </div>
        <!-- End Page Title -->
                ...
                <table
                    ...
                    <thead class="thead-light thead-50 text-capitalize">
                        <tr>
                            ...
                            <th>{{\App\CPU\translate('organization')}}</th>
