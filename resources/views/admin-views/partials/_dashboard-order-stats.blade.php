...
<div class="col-sm-6 col-lg-3 mb-2">
    ...
    <div class="business-analytics cursor-pointer border-0 pt-3 total__product__up carddivsec"
        ...
        <div>
            <h5 class="business-analytics__subtitle">{{\App\CPU\translate('Total Quality Member')}}</h5>
...
<div class="col-sm-6 col-lg-3 mb-2">
    ...
    <div class="business-analytics cursor-pointer border-0 pt-3 total__product__up carddivsec"
        ...
        <div>
            <h5 class="business-analytics__subtitle">{{\App\CPU\translate('Total Assessor Member')}}</h5>
...
<div class="col-sm-6 col-lg-3 mb-2">
    ...
    <div class="business-analytics cursor-pointer border-0 pt-3 total__product__up carddivsec"
        ...
        <div>
            <h5 class="business-analytics__subtitle">{{\App\CPU\translate('Total Accreditation Member')}}</h5>
