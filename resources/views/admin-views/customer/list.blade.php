            ...
            <div class="table-responsive datatable-custom">
                <table
                    ...
                    <tr>
                        ...
                        <th>{{\App\CPU\translate('Total')}} {{\App\CPU\translate('Application')}} </th>
                    ...
                    @foreach($customers as $key=>$customer)
                        <tr>
                            ...
                            <td>
                                <div class="mb-1">
                                    <strong><a class="title-color hover-c1" href="tel:{{$customer->phone}}">{{$customer->phone}}</a></strong>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a title="{{\App\CPU\translate('Edit')}}"
                                       ...
                                       href="{{ route('admin.customer.edit-customer', ['id' => $customer['id']]) }}">
                                        <i class="tio-edit"></i>
                                    </a>
