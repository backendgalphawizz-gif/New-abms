...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="mb-3 customBtnDiv">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2 editback justify-content-between">
                <div class="imageicon">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="f_name" class="form-control" id="f_name"
                                            ...
                                            value="{{ $user->f_name ?? old('f_name') }}" required>
                                    </div>
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label for="user_image" class="title-color">{{ \App\CPU\translate('user_image') }}</label>
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input type="number" name="age" value="{{ $user->age ?? old('age') }}"
                                            class="form-control" id="age"
                                            placeholder="{{ \App\CPU\translate('Ex') }} : 20"
                                            maxlength="3" required>
                                    </div> -->
                                    <!-- <div class="form-group">
                                        <label for="city" class="title-color">{{ \App\CPU\translate('City') }}</label>
                                        <input type="text" name="city" value="{{ $user->city ?? old('city') }}"
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input type="text" name="address" value="{{ $user->street_address ?? old('address') }}"
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <select name="gender" class="form-control" id="gender" required>
                                            ...
                                            <option value="male" {{ ($user->gender ?? old('gender')) == 'male' ? 'selected' : '' }}>
                                                {{ \App\CPU\translate('Male') }}</option>
                                            <option value="female" {{ ($user->gender ?? old('gender')) == 'female' ? 'selected' : '' }}>
                                                {{ \App\CPU\translate('Female') }}</option>
                                            <option value="other" {{ ($user->gender ?? old('gender')) == 'other' ? 'selected' : '' }}>
                                            ...
                                            @if (isset($zipcode))
                                                @foreach ($zipcode as $key => $value)
                                                    <option value="{{ $value->zipcode }}"
                                                        {{ ($user->zipcode ?? old('zipcode')) == $value->zipcode ? 'selected' : '' }}>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="l_name" class="title-color">{{ \App\CPU\translate('Last Name') }}</label>
                                        <input type="text" name="l_name" class="form-control" id="l_name"
                                            placeholder="{{ \App\CPU\translate('last_name') }}"
                                            value="{{ $user->l_name ?? old('l_name') }}" >
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shop_lat"
                                        class="form-control" id="shop_lat"
                                        value="{{ old('shop_lat', $user->shop_lat) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       <input type="text" name="shop_lng"
                                        class="form-control" id="shop_lng"
                                        value="{{ old('shop_lng', $user->shop_lng) }}"
                                        placeholder="{{ \App\CPU\translate('shop lng') }}" required>

                                    </div>
                                </div>
                                <input type="hidden" name="country"   value="{{ $user->country ?? old('country') }}">
                                <div class="col-md-4">
                                    <div class=" form-group">
                                        <label for="state" class="title-color d-flex gap-1 align-items-center">{{\App\CPU\translate('State')}}</label>
                                      <select name="state" class="form-control" id="state">
                                        @foreach ($states as $value)
                                            <option value="{{ $value->id }}" data-id="{{ $value->id }}"
                                            {{ old('state', $user->state) == $value->id ? 'selected' : '' }}>
                                            {{ $value->name }}
                                        </option>
                               ...
                               <div class="col-md-4">
                                    ...
                                    <select name="area" id="area" class="form-control">
                                        ...
                                        @foreach($areas as $area)
                                            <option value="{{ $area->id }}"
                                                {{ old('area', $user->area) == $area->id ? 'selected' : '' }}>
                                                {{ $area->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" value="{{ $user->email ?? old('email') }}"
                                            class="form-control" id="email"
                                            placeholder="{{ \App\CPU\translate('Ex') }} : ex@gmail.com" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
