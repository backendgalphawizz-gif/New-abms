                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-sm-8 col-md-6 col-lg-4">
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    ...
                                    <div class="input-group input-group-merge input-group-custom mb-2">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <i class="tio-search"></i>
                                            </div>
                                    ...
                                    <div class="input-group input-group-merge input-group-custom mb-2">
                                        ...
                                        <select id="area_id" name="areas[]" multiple="multiple" style="width: 100%;" data-placeholder="Search by Area"></select>
                                    </div>
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                ...
                                <th>{{\App\CPU\translate('seller_area')}}</th>
                                <th>{{\App\CPU\translate('otp')}}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a title="{{\App\CPU\translate('View')}}"
                                           class="title-color"
                                           href="{{route('admin.sellers.view',$seller->id)}}">
                                             {{ $seller->shop->areas->name ?? 'No area assigned' }}
                                    ...
                                    <td class="actiondiv">
                                        ...
                                        <!-- Login Access to vendor panel -->
                                        <!-- <div class="d-flex justify-content-center gap-2">
                                            <a title="{{\App\CPU\translate('Login as Vendor')}}"
                                                class="btn btn-outline-info btn-sm square-btn"
                                                href="{{route('admin.sellers.seller-login', $seller->id)}}">
                                        ...
                                        <!-- <div class="d-flex justify-content-center gap-2">
                                            <a title="{{\App\CPU\translate('Categories & Subcategories')}}"
                                                class="btn btn-outline-info btn-sm square-btn"
                                                href="{{ route('admin.sellers.view',['id'=>$seller->id, 'tab'=>'requested-categories']) }}">
