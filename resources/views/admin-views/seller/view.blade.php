...
@section('content')
    <div class="content container-fluid">
        <!-- Page Title -->
        <div class="mb-3 backbtndiv">
            <a href="{{route('admin.sellers.seller-list')}}"
                   class="btn btn--primary mt-3 mb-3"><i class="tio-chevron-left"></i>{{\App\CPU\translate('Back_to_seller_list')}}</a>
                ...
                <div class="col-md-6 mt-2 mt-md-0">
                    <div class="card">
                        ...
                        <div class="card-body"
                            ...
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('shop_name')}} : </h5></div>
                            ...
                            <div class="flex-start">
                                ...
                                <div class="mx-1"><h5>{{$seller->shop->email}}</h5></div>
                            </div>
                         <div class="d-flex align-items-start">
                            ...
                            <div class="mx-1">
                                <h5>
                                    {{ $seller->shop->address }},
                                    {{ $seller->shop->cities?->name ?? '' }},
                                    {{ $seller->shop->states?->name ?? '' }},
                                    {{ $seller->shop->areas?->name ?? '' }},
                                    {{ $seller->shop->country }}
                                </h5>
                            </div>
                        </div>
                            ...
                            <!-- <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('bussiness_type')}} : </h5></div>
                                <div class="mx-1"><h5>{{$seller->shop->bussiness_type}}</h5></div>
                            </div>
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('registeration_number')}} : </h5></div>
                                <div class="mx-1"><h5>{{$seller->shop->registeration_number}}</h5></div>
                            </div> -->
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('gst_in')}} : </h5></div>
                                <div class="mx-1"><h5>{{$seller->shop->gst_in}}</h5></div>
                            </div>
                            <!-- <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('tax_identification_number')}} : </h5></div>
                                <div class="mx-1"><h5>{{$seller->shop->tax_identification_number}}</h5></div>
                            </div>
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('website_link')}} : </h5></div>
                                <div class="mx-1"><h5>{{$seller->shop->website_link}}</h5></div>
                            </div> -->
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                            ...
                            <div class="flex-start">
                                <div><h6>{{\App\CPU\translate('ifsc_code')}} : </h6></div>
                                <div class="mx-1">
                                    <h6>{{$seller->ifsc_code ? $seller->ifsc_code : \App\CPU\translate('No Data found')}}</h6>
                                </div>
                            </div>
                            <!-- <div class="flex-start">
                                <div><h6>{{\App\CPU\translate('micr_code')}} : </h6></div>
                                <div class="mx-1">
                                    <h6>{{$seller->micr_code ? $seller->micr_code : \App\CPU\translate('No Data found')}}</h6>
                                </div>
                            </div> -->

                            <div class="flex-start">
                                <div><h6>{{\App\CPU\translate('account_type')}} : </h6></div>
                                <div class="mx-1">
                                    <h6>{{$seller->account_type ? $seller->account_type : \App\CPU\translate('No Data found')}}</h6>
                                </div>
                            </div>

                            <div class="flex-start">
                                <div><h6>{{\App\CPU\translate('bank_address')}} : </h6></div>
                                <div class="mx-1">
                                    <h6>{{$seller->bank_address ? $seller->bank_address : \App\CPU\translate('No Data found')}}</h6>
                                </div>
                            </div>
