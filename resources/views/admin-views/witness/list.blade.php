                    ...
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admin.application.store-witness')}}" method="POST" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="title-color" for="priority">{{ \App\CPU\translate('Witness Type') }}(Standards / Regulations / Methods / Procedures)</label>
                                        ...
                                        <input type="text" class="form-control" name="standards" required>
                                    </div>
                                </div>

                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="title-color" for="priority">{{ \App\CPU\translate('Technical Area/IAF Code/Product') }}</label>
