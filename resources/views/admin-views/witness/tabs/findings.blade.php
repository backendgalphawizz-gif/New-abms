@php
    ...
    $checklist = AssessmentFinding::where('finding_type', 'witness_assessment')->where('application_id', $witness->application_id)->get();
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($clause->action_proposed_by_cab)
                                            ...
                                            <br>
                                            <b>Attachments : </b>
                                            @if (isset($cabAction['attachments']))
                                                @if(!empty($cabAction['attachments']))
                                                    @for ($i=0; $i<count($cabAction['attachments']); $i++)
                                                        <a href="{{ asset($cabAction['attachments'][$i]) }}" target="_blank">
                                                            <img src="{{ asset($cabAction['attachments'][$i]) }}" style="width:50px; height:50px;"/>                                                    
                                                        </a>
                                                    @endfor
                                                @endif
                                            @else
