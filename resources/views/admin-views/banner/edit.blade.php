                        ...
                        <form action="{{route('admin.banner.update',[$banner['id']])}}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group d-none">
                                        ...
                                        <select class="js-example-responsive form-control w-100"
                                            ...
                                            <option value="Main Banner" selected {{$banner['banner_type']=='Main Banner'?'selected':''}}>Main Banner</option>
                                ...
                                <div class="col-md-12 d-flex justify-content-end gap-3">
                                    ...
                                    <button type="botton" class="btn btn-secondary px-4" onclick="window.location.href='{{ route('admin.banner.list') }}'">{{ \App\CPU\translate('back')}}</button>
...
@push('script')
    <script>
        ...
        if (theme_ratio[theme] && theme_ratio[theme][banner_type]) {
            let get_ratio = theme_ratio[theme][banner_type];
            $('#theme_ratio').text(get_ratio);
        } else {
            console.warn('No ratio found for', theme, banner_type);
            $('#theme_ratio').text('N/A'); 
        }
    }
