                ...
                <form id="submit-create-role" method="post" action="{{route('admin.custom-role.store')}}"
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3 d-none">
                            <div class="form-group d-flex gap-2">
                                <input type="checkbox" name="modules[]" value="dashboard" class="module-permission" id="dashboard" checked>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group d-flex gap-2">
                                <input type="checkbox" class="module-permission" name="modules[]" value="application_management" id="application_management">
                                <label class="title-color mb-0" style="{{Session::get('direction') === "rtl" ? 'margin-right: 1.25rem;' : ''}};"
                                        for="application_management">{{\App\CPU\translate('application_management')}}</label>
                            </div>
                        </div> 
                        <div class="col-sm-6 col-lg-3 d-none">
                            <div class="form-group d-flex gap-2">
                                <input type="checkbox" class="module-permission" name="modules[]" value="transaction_management" id="transaction_management">
                                <label class="title-color mb-0" style="{{Session::get('direction') === "rtl" ? 'margin-right: 1.25rem;' : ''}};"
                                        for="transaction_management">{{\App\CPU\translate('transaction_management')}}</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3 d-none">
                            <div class="form-group d-flex gap-2">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group d-flex gap-2">
                                ...
                                <label class="title-color mb-0" style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                    for="employee_management">{{ \App\CPU\translate('Employee_Management') }}</label>
                            </div>
                        </div>

                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group d-flex gap-2">
                                <input type="checkbox" class="module-permission" name="modules[]" value="training_management" id="training_management">
                                <label class="title-color mb-0" style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                    for="training_management">{{ \App\CPU\translate('Training_Management') }}</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group d-flex gap-2">
                                <input type="checkbox" class="module-permission" name="modules[]" value="fee_management" id="fee_management">
                                <label class="title-color mb-0" style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                                    for="fee_management">{{ \App\CPU\translate('Fee_Management') }}</label>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2 justify-content-center">
                                        ...
                                        <a href="#"
                                            class="btn btn-outline-danger btn-sm delete d-none"
