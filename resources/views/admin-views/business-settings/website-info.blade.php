                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="col-md-4 d-none">
                            @php($app_marque_text=\App\Model\BusinessSetting::where('type','app_marque_text')->first())
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\translate('header_marque_text')}}</label>
                                <input class="form-control" type="text" name="app_marque_text"
                                    value="{{ $app_marque_text->value?$app_marque_text->value:" " }}"
                                    placeholder="New Business">
                            </div>
                        </div>
                    </div>
           ...
           <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        @php($bank_holder=\App\Model\BusinessSetting::where('type','bank_holder_name')->first())
                        <div class="form-group">
                            <label class="title-color d-flex">Account Holder Name</label>
                            <input class="form-control" type="text" name="bank_holder_name"
                                value="{{ $bank_holder->value ?? '' }}"
                    ...
                    <div class="col-md-4">
                        @php($bank_number=\App\Model\BusinessSetting::where('type','bank_account_number')->first())
                        <div class="form-group">
                            <label class="title-color d-flex">Account Number</label>
                    ...
                    <div class="col-md-4">
                        @php($bank_ifsc=\App\Model\BusinessSetting::where('type','bank_ifsc')->first())
                        <div class="form-group">
                            <label class="title-color d-flex">IFSC Code</label>
                            <input class="form-control text-uppercase"
                                type="text"
                                maxlength="11"
                                name="bank_ifsc"
                                value="{{ $bank_ifsc->value ?? '' }}"
                    ...
                    <div class="col-md-4">
                        @php($bank_name=\App\Model\BusinessSetting::where('type','bank_name')->first())
                        <div class="form-group">
                            <label class="title-color d-flex">Bank Name</label>
                            <input class="form-control"
                                type="text"
                                name="bank_name"
                    ...
                    <div class="col-md-4">
                        @php($bank_branch=\App\Model\BusinessSetting::where('type','bank_branch_name')->first())
                        <div class="form-group">
                            <label class="title-color d-flex">Branch Name</label>
                            <input class="form-control"
                                type="text"
                                name="bank_branch_name"
                                value="{{ $bank_branch->value ?? '' }}"
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex align-items-center gap-2">
                                ...
                                {{ \App\CPU\translate('App Header Color') }}
                            </h5>
                        </div>
                        <div class="card-body d-flex flex-wrap gap-4">
                            @php($appColors = \App\Model\BusinessSetting::where(['type' => 'app_header_colors'])->first())
                            @if(isset($appColors))
                                @php($appColorData = json_decode($appColors['value']))
                            @else
                            ...
                            <div class="form-group">
                                <input type="color" name="header_color" value="{{ $appColorData->header_color ?? '#000000' }}"
                                    class="form-control form-control_color">
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3">{{ strtoupper($appColorData->header_color ?? '#000000') }}</div>
                                    <label class="title-color text-capitalize">{{ \App\CPU\translate('Header Color 1') }}</label>
                                </div>
                            </div>

                            <div class="form-group">
                                <input type="color" name="text_color" value="{{ $appColorData->text_color ?? '#FFFFFF' }}"
                                    class="form-control form-control_color">
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3">{{ strtoupper($appColorData->text_color ?? '#FFFFFF') }}</div>
                                    <label class="title-color text-capitalize">{{ \App\CPU\translate('Header Color 2') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
