            ...
            <div class="row g-3">
                ...
                <div class="col-lg-9">
                    <div class="card h-100">
                        <div class="card-body refund-details-page p-lg-5">
                            <div class="mb-4">
                                ...
                                <form action="#">
                                    <div class="d-flex flex-column flex-sm-row flex-wrap gap-4 justify-content-between mb-4">
                                        ...
                                        <div class="d-flex flex-column gap-1 fs-12">
                                            <span><b>{{ translate('QTY') }} </b>: {{\App\CPU\Helpers::currency_converter($order_details->qty)}}</span>
                                            <span><b>{{ translate('price') }}</b> : {{\App\CPU\Helpers::currency_converter($order_details->price)}}</span>
                                            <span><b>{{ translate('discount') }} </b>: {{\App\CPU\Helpers::currency_converter($order_details->discount)}}</span>
                                            <span><b>{{ translate('tax') }} </b>: {{\App\CPU\Helpers::currency_converter($order_details->tax)}}</span>
                                        </div>
