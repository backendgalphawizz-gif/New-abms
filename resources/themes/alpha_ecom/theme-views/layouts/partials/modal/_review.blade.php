<!-- Review Modal -->
<div class="modal fade for-review" id="reviewModal{{$id}}" tabindex="-1" aria-labelledby="reviewModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-sm-5">
                    <div class="form-group mb-4">
                       ...
                       <div class="rating1 mb-2" id="rating" name="rating">
