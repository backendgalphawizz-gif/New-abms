<div class="col-lg-4">
    <div class="card text-dark h-100 border-0 bg-light-gery colorchnage sticky-top">
        <div class="card-body px-sm-4 d-flex flex-column gap-2">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                ...
                <div class="text__green__color">{{\App\CPU\Helpers::currency_converter($total_shipping_cost)}}</div>
            </div>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                ...
                <h2 class="text__green__color">{{\App\CPU\Helpers::currency_converter($product_price_total+$total_tax+$total_shipping_cost-$coupon_dis-$total_discount_on_product-$order_wise_shipping_discount)}}</h2>
            </div>
