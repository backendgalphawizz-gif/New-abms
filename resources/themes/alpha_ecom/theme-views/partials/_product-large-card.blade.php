...
<div class="product border rounded text-center d-flex flex-column gap-10 ov-hidden cursor-pointer"
    ...
    <!-- Product top -->
    <div class="product__top d-none" style="--width: 100%;">
    ...
    <!-- Product Summery -->
    <div class="product__summary d-none flex-column align-items-center gap-1 pb-3 cursor-pointer ">
        ...
        <!-- This data is taked from Small card Page -->
            ...
            <div class="card view-card-item-white-theme">
                ...
                <div class="item-detail-cart">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="item-like cursor-pointer">
                    ...
                    <div class="content-item-cart">
                        <a href="{{route('product',$product->slug)}}" class="text-capitalize name-item black-text">{{ Str::limit($product['name'], 23) }}</a>
                        <p class="item-bill">
