                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="quantity quantity--style-two d-inline-flex">
                                                    <span class="quantity__minus " onclick="updateCartQuantityList('{{ $minimum_order->minimum_order_qty ?? 1 }}', '{{$cartItem['id']}}', '-1', '{{ isset($minimum_order->minimum_order_qty) && $cartItem['quantity'] == $minimum_order->minimum_order_qty ? 'delete':'minus' }}')">
                                                    ...
                                                    <input type="text" class="quantity__qty" value="{{$cartItem['quantity']}}" name="quantity[{{ $cartItem['id'] }}]" id="cartQuantity{{$cartItem['id']}}"
                                                           onchange="updateCartQuantityList('{{ $minimum_order->minimum_order_qty ?? 1 }}', '{{$cartItem['id']}}', '0')" data-min="{{ isset($cartItem->product->minimum_order_qty) ? $cartItem->product->minimum_order_qty : 1 }}">
                                                    <span class="quantity__plus" onclick="updateCartQuantityList('{{ $minimum_order->minimum_order_qty ?? 1 }}', '{{$cartItem['id']}}', '1')">
