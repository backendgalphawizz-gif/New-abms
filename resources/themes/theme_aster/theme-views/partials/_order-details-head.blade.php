...
<div class="mt-4">
    <nav>
        <div class="nav nav-nowrap gap-3 gap-xl-4 nav--tabs hide-scrollbar">
            ...
            <a href="{{ route('account-order-details-delivery-man-info', ['id'=>$order->id]) }}" class="d-none {{Request::is('account-order-details-delivery-man-info')  ? 'active' :''}}" >{{translate('Delivery_Man_Info')}}</a>
