...
<div class="__inline-9 rtl">
            ...
            <div >
                <a href="{{route('about-us')}}">
                    <div class="text-center">
                        <img class="size-60" src="{{ storefront_public_uri('public/assets/front-end/png/about company.png') }}"
                                alt="">
                    </div>
                    <div class="text-center">
        ...
        <div class="col-md-3 d-flex justify-content-center">
            <div >
                <a href="{{route('contacts')}}">
                    <div class="text-center">
                        <img class="size-60" src="{{ storefront_public_uri('public/assets/front-end/png/contact us.png') }}"
                                alt="">
                    </div>
                    <div class="text-center">
                        <p class="m-0">
        ...
        <div class="col-md-3 d-flex justify-content-center">
            <div >
                <a href="{{route('helpTopic')}}">
                    <div class="text-center">
                        <img class="size-60" src="{{ storefront_public_uri('public/assets/front-end/png/faq.png') }}"
                                alt="">
                    </div>
                    <div class="text-center">
                        <p class="m-0">
    ...
    <footer class="page-footer font-small mdb-color rtl">
                    ...
                    <div class="col-md-3 footer-web-logo" >
                        <a class="d-block" href="{{route('home')}}">
                            <img class="{{Session::get('direction') === "rtl" ? 'rightalign' : ''}}" src="{{asset("storage/app/public/company/")}}/{{ $web_config['footer_logo']->value }}"
                                onerror="this.src='{{ storefront_public_uri('public/assets/front-end/img/image-place-holder.png') }}'"
                            ...
                            @if($web_config['ios']['status'])
                                <div class="{{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}} mb-2">
                                    <a class="" href="{{ $web_config['ios']['link'] }}" role="button">
                                        <img class="w-100" src="{{ storefront_public_uri('public/assets/front-end/png/apple_app.png') }}"
                                            alt="">
                                    </a>
                                </div>
                            @endif
                            ...
                            @if($web_config['android']['status'])
                                <div class="{{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}} mb-2">
                                    <a href="{{ $web_config['android']['link'] }}" role="button">
                                        <img class="w-100" src="{{ storefront_public_uri('public/assets/front-end/png/google_app.png') }}" alt="">
                                    </a>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 footer-padding-bottom" style="{{Session::get('direction') === "rtl" ? 'padding-right:20px;' : ''}}">
                                ...
                                @else
                                    <ul class="widget-list __pb-10px">
                                        <li class="widget-list-item">
                                            <a class="widget-list-link" href="{{route('customer.login.short')}}">{{\App\CPU\translate('profile_info')}}</a>
                                        </li>
                                        <li class="widget-list-item">
                                            <a class="widget-list-link" href="{{route('customer.login.short')}}">{{\App\CPU\translate('wish_list')}}</a>
                                        </li>
                                ...
                                <div class="row ">
                                    <div class="col-11 start_address ">
                                        ...
                                        <div>
                                            ...
                                            @else
                                                <a class="widget-list-link" href="{{route('customer.login.short')}}">
                                                    <span ><i class="fa fa-user-o m-2"></i> {{ \App\CPU\translate('Support Ticket')}} </span>
                                                </a><br>
                                            @endif
                                        </div>
        ...
        <!-- Cookie Settings -->
        @php($cookieSetting = $web_config['cookie_setting'] ?? null)
        @php($cookieRaw = $cookieSetting ? (is_array($cookieSetting) ? ($cookieSetting['value'] ?? null) : ($cookieSetting->value ?? null)) : null)
        @php($cookie = ($cookieRaw !== null && $cookieRaw !== '') ? json_decode((string) $cookieRaw, true) : null)
        @if(is_array($cookie) && !empty($cookie['status']) && (int) $cookie['status'] === 1)
