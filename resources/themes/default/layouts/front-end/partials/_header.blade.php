                        ...
                        @foreach(json_decode($language['value'],true) as $data)
                            @if($data['code']==$local)
                                <img class="{{Session::get('direction') === "rtl" ? 'mr-2' : 'mr-2'}}" width="20"
                                     src="{{ storefront_public_uri('public/assets/front-end') }}/img/flags/{{$data['code']}}.png"
                                     alt="Eng">
                                {{$data['name']}}
                            @endif
                        @endforeach
        ...
        <div class="navbar navbar-expand-md navbar-light">
            <div class="container ">
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    ...
                    @else
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu __auth-dropdown dropdown-menu-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}" aria-labelledby="dropdownMenuButton"
                                 style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                                <a class="dropdown-item" href="{{route('customer.login.short')}}">
                                    <i class="fa fa-sign-in {{Session::get('direction') === "rtl" ? 'mr-2' : 'mr-2'}}"></i> {{\App\CPU\translate('sign_in')}}
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('customer.signup')}}">
                    ...
                    @endif
                    <div id="cart_items">
                        @unless(request()->is('login', 'signup', 'sign-up', 'customer/auth/*'))
            ...
            <div class="container px-10px">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        @if(optional(\App\Model\BusinessSetting::where(['type'=>'product_brand'])->first())->value)
                        <li class="nav-item dropdown">
                        ...
                        @if ($business_mode == 'multi')
                            ...
                            @php($seller_registration = optional(\App\Model\BusinessSetting::where(['type'=>'seller_registration'])->first())->value)
