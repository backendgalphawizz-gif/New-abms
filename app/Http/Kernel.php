...
use App\Http\Middleware\AssessorApiAuthMiddleware;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        \App\Http\Middleware\ServeLegacyPublicPrefixedStaticAssets::class,
    ...
    protected $routeMiddleware = [
        ...
        'assessor_api_auth' => AssessorApiAuthMiddleware::class,
