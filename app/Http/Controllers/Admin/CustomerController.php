...
{
    /**
     * Customer users are stored in the tenant database. On tenant hosts (Stancl),
     * this list is automatically scoped to the current subdomain’s entity—no extra domain column.
     */
    ...
    public function add_new()
    {
        ...
        return view('admin-views.customer.add-new',  ['states' => $states]);
    }
    public function edit_customer($id)
    {
        ...
        $areas = Area::where('city_id', $user->city)->orderBy('name', 'asc')->get();
        return view('admin-views.customer.edit-customer', [
            'user' => $user,
            'states' => $states,
            'areas'  => $areas,
            'cities' => $cities
