...
class ForgotPasswordController extends Controller
{
    public function reset_password_request(Request $request)
    {
        ...
        if ($verification_by == 'email') {
            ...
            if (isset($seller)) {
                ...
                return response()->json(['status' => true, 'message' => 'otp sent successfully.', 'otp' => $token], 200);
            }
        }
    ...
    public function reset_password_submit(Request $request)
    {
        ...
        if ($validator->fails()) {
            return response()->json(['status'=> false, 'message' => 'Invalid OTP.', 'errors' => Helpers::error_processor($validator)], 403);
        }
        ...
        if (isset($data)) {
            ...
            return response()->json(['status'=> true, 'message' => 'Password changed successfully.', 'errors' => []], 200);
        }
        return response()->json([
            'status'=> false, 'message' => 'Invalid OTP.', 'errors' =>[]
        ], 400);
    }
}
