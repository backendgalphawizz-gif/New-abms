...
class ConfigController extends Controller
{
    public function configuration()
    {
        ...
        $bank_details = [
            'bank_name' => Helpers::get_business_settings('bank_name'),
            'bank_ifsc' => Helpers::get_business_settings('bank_ifsc'),
            'bank_branch_name' => Helpers::get_business_settings('bank_branch_name'),
            'bank_account_number' => Helpers::get_business_settings('bank_account_number'),
            'bank_holder_name' => Helpers::get_business_settings('bank_holder_name'),
        ];
    ...
    public function appHome() {
        ...
        $setting['summer_sale_banner']['image'] = asset('storage/app/public/product/' . $setting['summer_sale_banner']['image']);
        $setting['prime_time_banner']['image'] = asset('storage/app/public/product/' . $setting['prime_time_banner']['image']);

        $top_deal_product = Product::with(['rating','tags'])->whereIn('id', explode(',', $setting['top_deal_product']['product_ids']))->get();

        $products = Product::with(['rating','tags'])->whereIn('id', explode(',', $setting['gift_section']['gift_product_ids']))->get();
        $setting['top_deal_product']['products'] = Helpers::product_data_formatting($top_deal_product, true) ?? [];
        $setting['gift_section']['products'] = Helpers::product_data_formatting($products, true) ?? [];
    ...
    public function Policies() {
        $setting = [
            ...
            'shipping_delivery_policy' => Helpers::get_business_settings('shipping-policy'),
            'security_policy_policy' => Helpers::get_business_settings('security-policy-policy'),
            'payment_policy' => Helpers::get_business_settings('payment-policy'),
            'condition_of_use_policy' => Helpers::get_business_settings('condition-of-use-policy'),
            'security_information' => Helpers::get_business_settings('security-information'),
            'contact_us' => Helpers::get_business_settings('contact-us'),
            'vendor-terms-policy' => Helpers::get_business_settings('vendor-terms-policy'),
            'vendor-privacy-policy' => Helpers::get_business_settings('vendor-privacy-policy')
