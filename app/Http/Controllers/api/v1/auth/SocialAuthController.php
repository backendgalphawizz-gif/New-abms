...
class SocialAuthController extends Controller
{
    public function social_login(Request $request)
    {
        ...
        try {
            ...
            return response()->json(['status' => false, 'token' => '', 'message' => 'Something went wrong', 'data' => [], 'errors' => []]);
        }
        ...
        if (strcmp($email, $data['email']) === 0) {
            ...
            if ($token != null) {
                return response()->json(['status' => true, 'message' => $message, 'token' => $token, 'data' => [], 'errors' => []]);
            }
            return response()->json(['status' => false, 'message' => translate('Customer_not_found_or_Account_has_been_suspended'), 'token' => "", 'data' => [], 'errors' => []]);
        }
