...
class DeliveryManController extends Controller
{
    ...
    public function earning_statement(Request $request, $id)
    {
        ...
        $total_order_amount = Order::where('delivery_man_id', $id)
            ->sum('order_amount');
        // dd($total_order_amount, $delivery_man);

        return view('seller-views.delivery-man.earning-statement.overview', compact('delivery_man', 'withdrawbale_balance', 'total_order_amount'));
    }
    ...
    {
    $drivers = DeliveryMan::select('id', 'f_name', 'l_name')
        ->where('seller_id', auth('seller')->id())
        ->get();
    ...
    return view('seller-views.delivery-man.assign-bulk-order', compact('drivers', 'orders', 'unassigned_orders'));
    }
