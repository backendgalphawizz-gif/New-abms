...
class ProductController extends Controller
{
    ...
    public function bulk_import_data(Request $request)
    {
        ...
        $data = [];
        $col_key = ['name', 'category_id', 'sub_category_id', 'sub_sub_category_id', 'brand_id', 'unit', 'min_qty', 'net_weight', 'youtube_video_url', 'unit_price', 'purchase_price', 'tax', 'discount', 'discount_type', 'current_stock', 'details', 'thumbnail'];
    ...
    //         $selling_price = $old_unit_price - number_format($selling_price, 2);
