...
class ShopController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $shop = Shop::find($id);
        if(isset($request->bussiness_email)) {
        ...
        if(isset($request->bissiness_registeration_number)) {
            $shop->registeration_number = $request->bissiness_registeration_number;
        }

        if(isset($request->gst_in)) {
