...
class SchemeProductCertification extends Model
{
    use CommonTrait;
    protected $table = 'product_certification_body_applications';
    protected $casts = [
        'scope_of_product' => 'json',
        'testing_laboratory_data' => 'json',
    ];
