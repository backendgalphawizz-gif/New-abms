...
class Brand extends Model
{
    ...
    /**
     * Home / theme sliders; empty when `brands` is not provisioned.
     */
    public static function forStorefrontHome(int $limit = 15): Collection
    {
        ...
        try {
            return static::active()->take($limit)->get();
        } catch (\Throwable $e) {
            return collect();
        }
    }
