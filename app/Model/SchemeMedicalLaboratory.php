...
class SchemeMedicalLaboratory extends Model
{

    use CommonTrait;
    protected $table = 'medical_laboratory_applications';
    protected $casts = [
        'primary_sample_collections' => 'json',
        'main_lab' => 'json',
        'branch_address' => 'json',
        'branch_activites' => 'json',
        'list_of_equipment' => 'json',
        'lab_equipment'=>'json',
