...
class SchemeBiotechnologyBiobank extends Model
{
    use CommonTrait;
    protected $table = 'biotechnology_organization_applications';
    protected $casts = [
        'category' => 'json',
        'source_of_material' => 'json',
        'scope_of_testing' => 'json',
        'equipment_activities_of_biobank' => 'json',
        'staff_list' => 'json',
        'bio_bank_activities' => 'json',
        'lab_equipment'=>'json',
