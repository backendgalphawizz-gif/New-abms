...
class SchemePersonCertification extends Model
{
    use CommonTrait;
    protected $table = 'person_certification_body_applications';
    protected $casts = [
        'location_data' => 'json',
        'already_accreditation_detail' => 'json',
        'another_accreditation_detail' => 'json',
        'staff_applying_details' => 'json',
        'quality_system' => 'json',
        'scope_of_application' => 'json',
    ];
